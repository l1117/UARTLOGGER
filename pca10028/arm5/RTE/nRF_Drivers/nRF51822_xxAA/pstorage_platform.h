...
#define PSTORAGE_MAX_APPLICATIONS   140                                                         /**< 140 ; 148 Maximum number of applications that can be registered with the module, configurable based on system requirements. */
